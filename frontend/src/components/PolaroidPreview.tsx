...
export default function PolaroidPreview(){
  ...
  <div className="polaroid-frame hover:scale-105 hover:shadow-xl transition-all duration-300" onClick={(e) => { e.stopPropagation(); if (!showCamera && !showDescInput) openCamera() }} title="Click to add photo">
        {imageSrc ? (
